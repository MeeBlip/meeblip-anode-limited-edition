...
;-------------------------------------------------------------------------------------------------------------------
;                       _     _ _                               _                 _     _ _       
;   _ __ ___   ___  ___| |__ | (_)_ __     __ _ _ __   ___   __| | ___  __      _| |__ (_) |_ ___ 
;  | '_ ` _ \ / _ \/ _ \ '_ \| | | '_ \   / _` | '_ \ / _ \ / _` |/ _ \ \ \ /\ / / '_ \| | __/ _ \
;  | | | | | |  __/  __/ |_) | | | |_) | | (_| | | | | (_) | (_| |  __/  \ V  V /| | | | | ||  __/
;  |_| |_| |_|\___|\___|_.__/|_|_| .__/   \__,_|_| |_|\___/ \__,_|\___|   \_/\_/ |_| |_|_|\__\___|
;                              |_|                                                     
;-------------------------------------------------------------------------------------------------------------------
;
;Change log
;
;V2.50 2015.10.16 - Added MIDI CCs for amp and filter ATTACK
;V2.11 2015.07.17 - Updated oscillator mix code
;				  - Digital prefiltering resonance set to 1 instead of zero
;				  - Reduced knob dead zone to 2
;				  - Added deadzone at centre of detune knob to allow exact oscillator sync without beating
;V2.10 2015.06.10 - Added second envelope for filter
;				  - Updated front panel: AMP DECAY + FILTER DECAY knobs
;				  - Updated front panel: WAVE knob + WAVE BANK switch
;				  - First two wavetables replaced with PWM waveform + antialiased pulse wave 
